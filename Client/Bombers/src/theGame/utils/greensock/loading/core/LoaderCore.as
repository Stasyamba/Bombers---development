 ...
 **/
package theGame.utils.greensock.loading.core {
import theGame.utils.greensock.events.LoaderEvent;
import theGame.utils.greensock.loading.LoaderMax;
import theGame.utils.greensock.loading.LoaderStatus;
...
[Event(name="open",     type="theGame.utils.greensock.events.LoaderEvent")]
/** Dispatched each time the <code>bytesLoaded</code> value changes while loading (indicating progress). **/
[Event(name="progress", type="theGame.utils.greensock.events.LoaderEvent")]
/** Dispatched when the loader completes. **/
[Event(name="complete", type="theGame.utils.greensock.events.LoaderEvent")]
...
[Event(name="cancel",     type="theGame.utils.greensock.events.LoaderEvent")]
/** Dispatched when the loader fails. **/
[Event(name="fail",     type="theGame.utils.greensock.events.LoaderEvent")]
/** Dispatched when the loader experiences some type of error, like a SECURITY_ERROR or IO_ERROR. **/
[Event(name="error",     type="theGame.utils.greensock.events.LoaderEvent")]
/**
